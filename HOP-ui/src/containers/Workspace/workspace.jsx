  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(7px)', position: 'relative' }}>
      <Box style={{
        ...
        {successPopupOpen && (
          <Box style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'absolute', width: '38%', height: 'auto' }}>
            <Card style={{ backgroundColor: 'white', textAlign: 'center', width: '100%', position: 'relative' }}>
              <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                <img src={CloseIcon} alt="Success_Popup" style={{ height: '24px', width: '24px', margin: '16px', cursor: 'pointer' }} onClick={() => setSuccessPopupOpen(false)} />
              </div>
